...
public class bookTicketGUI implements ActionListener{
    JFrame frame;
    ...
    public bookTicketGUI(){
        ...
        JLabel imgJLabel=new JLabel(new ImageIcon("images/trainbg.png"));
       ...
       type.addActionListener(this);
        ...
        prevButton.setIcon(new ImageIcon("images/prev2.png")); 
